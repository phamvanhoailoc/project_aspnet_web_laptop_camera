#pragma checksum "D:\work\project-ecommerce-laptop-camera\project_aspnet_web_laptop_camera\WebApp_camera-laptop\Areas\Admin\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9fda3ee87f4bd7f7c825e27003c1ca9bef78d7e5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9fda3ee87f4bd7f7c825e27003c1ca9bef78d7e5", @"/Areas/Admin/Views/Home/Index.cshtml")]
    ...
    #nullable disable
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "D:\work\project-ecommerce-laptop-camera\project_aspnet_web_laptop_camera\WebApp_camera-laptop\Areas\Admin\Views\Home\Index.cshtml"
...
#nullable disable
    ...
    <div class=""row small-spacing"">
        <div class=""col-sm-6 col-lg-3 col-xs-12"">
            <div class=""box-content"">
                ...
                <div class=""content widget-stat"">
                    <div id=""traffic-sparkline-chart-3"" class=""left-cont");
        ...
        ");
          ...
          ");
            WriteLiteral(@"      <!-- /.content widget-stat -->
            </div>
            <!-- /.box-content -->
        </div>
        <!-- /.col-sm-6 col-lg-3 col-xs-12 -->
        ...
        <div class=""col-sm-6 col-lg-3 col-xs-12"">
            <div class=""box-content"">
                ...
                <!-- /.dropdown js__dropdown -->
   ");
            WriteLiteral(@"             <div class=""content widget-stat"">
        ...
        <div class=""col-sm-6 col-lg-3 col-xs-12"">
            <div class=""box-content"">
                ...
                <div class=""dropdown js__drop_down"">
                    <a href=""#"" clas");
            WriteLiteral(@"s=""dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button""></a>
                    <ul class=""sub-menu"">
                        <li><a href=""#"">Action</a></li>
                        <li><a href=""#"">Another action</a></li>
                        <li><a href=""#"">Something else there</a></li>
                ...
                <div class=""content widget-stat"">
                    ...
                    <div class=""right-content"">
                        ...
                        <!-- /.counter -->
                        <p class=""text text-orange"">S");
            WriteLiteral(@"ome text here</p>
                        <!-- /.text -->
                    </div>
                    <!-- .right-content -->
                </div>
   ...
   ");
            ...
            <div class=""box-content"">
                ...
                <div class=""dropdown js__drop_down"">
                    ...
                    <ul class=""sub-menu"">
                        ...
                        <li><a href=""#"">Another action</a></li>
                        <li><a href=""#"">Somethin");
            WriteLiteral(@"g else there</a></li>
                        <li class=""split""></li>
                        <li><a href=""#"">Separated link</a></li>
                    </ul>
                    <!-- /.sub-menu -->
    ...
    <div class=""row small-spacing"">
            ...
            WriteLiteral(@"lass=""fa fa-star""></i>
                    ...
                    <div class=""review-item"">
                        <div class=""top"">
                            ...
                            <!-- /.date -->
                            <div cl");
            WriteLiteral(@"ass=""star-rating text-warning"">
        ...
        <div class=""col-lg-4 col-xs-12"">
            <div class=""box-content"">
           ");
            WriteLiteral(@"     <h4 class=""box-title"">Activity</h4>
                <!-- /.box-title -->
                <div class=""dropdown js__drop_down"">
                    <a href=""#"" class=""dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button""></a>
                    <ul class=""sub-menu"">
            ...
            WriteLiteral(@""">View all activity <i class=""fa fa-angle-down""></i></a>
            </div>
            <!-- /.box-content -->
        </div>
        <!-- /.col-lg-4 col-xs-12 -->
        <div class=""col-lg-4 col-xs-12"">
            <div class=""box-content js__todo_widget"">
                ...
                <!-- /.dropdown js__dropdown -->
        ");
            WriteLiteral(@"        <div class=""todo-list js__todo_list"">
                    <div class=""todo-item"">
                    ...
                    <div class=""todo-item"">
                        <div class=""checkbox");
            WriteLiteral(@" success""><input type=""checkbox"" id=""todo-4""><label for=""todo-4"">Task To Do 4</label></div>
                        <!-- /.checkbox -->
                    </div>
                    <!-- /.todo-item -->
                    <div class=""todo-item"">
            ...
            WriteLiteral(@"eckbox -->
                ...
                <div class=""todo-form"">
                    <div class=""input-group"">
                        ...
                        <div class=""input-group-btn""><button type=""button"" class=""btn btn-");
            WriteLiteral(@"success no-border text-white js__todo_button waves-effect waves-light""><i class=""fa fa-plus""></i></button></div>
                        <!-- /.input-group-btn -->
                    </div>
                    <!-- /.input-group -->
                </div>
    ...
    <div class=""row small-spacing"">
        ...
        <div class=""col-lg-6 col-xs-12"">
            <div class=""box-content"">
                ...
                <!-- /.box-title -->
                <div class=""dropdown js__drop_down"">
                    <a href=""#"" class=""dropdown-icon glyph");
            WriteLiteral(@"icon glyphicon-option-vertical js__drop_down_button""></a>
                    <ul class=""sub-menu"">
            ...
            WriteLiteral(@"       <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href=""#""><i class");
            WriteLiteral(@"=""fa fa-plus-circle""></i></a></td>
                        </tr>
                        <tr>
                            <td>Ninja Admin</td>
                            <td>$200</td>
